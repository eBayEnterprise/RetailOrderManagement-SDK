...
class PayPalSetExpressCheckoutReplyTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @return PayPalSetExpressCheckoutReply
     */
    ...
    /**
     * Get a new PayPalSetExpressCheckoutReply payload. Each payload will contain a
    ...
    {
        return new PayPalSetExpressCheckoutReply($this->validatorIterator, $this->stubSchemaValidator);
    }
    ...
    {
        return $this->canonicalize(__DIR__ . "/Fixtures/PayPalSetExpressCheckoutReplyTest.xml");
    }
    ...
    {
        return $this->canonicalize(__DIR__ . "/Fixtures/InvalidPayPalSetExpressCheckoutReplyTest.xml");
    }
