...
class PayPalDoAuthorizationReplyTest extends \PHPUnit_Framework_TestCase
{
        ...
        return [
            [
                [
                    ...
                    'setPendingReason' => 'authorization',
                    'setReasonCode' => ''
                ]
            ],
        ];
     ...
     * @return PayPalDoAuthorizationReply
     */
    ...
    /**
     * Get a new PayPalDoAuthorizationReply payload. Each payload will contain a
    ...
    {
        return new PayPalDoAuthorizationReply($this->validatorIterator, $this->stubSchemaValidator);
    }
    ...
    {
        return $this->canonicalize(__DIR__ . "/Fixtures/PayPalDoAuthorizationReplyTest.xml");
    }
    ...
    {
        return $this->canonicalize(__DIR__ . "/Fixtures/InvalidPayPalDoAuthorizationReplyTest.xml");
    }
