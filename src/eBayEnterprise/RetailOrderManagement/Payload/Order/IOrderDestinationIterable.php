...
use eBayEnterprise\RetailOrderManagement\Payload\Checkout\IEmailAddressDestination;
use eBayEnterprise\RetailOrderManagement\Payload\Checkout\IMailingAddress;
